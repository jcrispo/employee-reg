...
import com.exist.utility.editMenu.subMenu.EditMenu;
import com.exist.utility.editMenu.subMenu.EditOptions;
...
public class EditMenu1Edit extends EditMenu1 {
    ...
    public void execute(String employeeNumberInput) {
        ...
        String condition = " WHERE E.id = " + employeeNumberInput;

        boolean exitEditMenu = false;
        while (!exitEditMenu) {
            view.showQueryNoLimit(HDBRetrieveManager.getQuery("SELECT_ALL_JOIN_ALL") + condition);
